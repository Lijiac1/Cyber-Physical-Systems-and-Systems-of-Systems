...
plot '144821_previous.csv' u ($1-1584540000000000):3 w lines,\
     '144821.csv' u ($1-1584540000000000):2 w lines,\
     '144821.csv' u ($1-1584540000000000):3 w lines

set title "145043.rec" offset -1,-1

plot '145043_previous.csv' u ($1-1584540000000000):3 w lines,\
     '145043.csv' u ($1-1584540000000000):2 w lines,\
     '145043.csv' u ($1-1584540000000000):3 w lines
     
set title "145233.rec" offset -1,-1

plot '145233_previous.csv' u ($1-1584540000000000):3 w lines,\
     '145233.csv' u ($1-1584540000000000):2 w lines,\
     '145233.csv' u ($1-1584540000000000):3 w lines
     
set title "145641.rec" offset -1,-1

plot '145641_previous.csv' u ($1-1584540000000000):3 w lines,\
     '145641.csv' u ($1-1584540000000000):2 w lines,\
     '145641.csv' u ($1-1584540000000000):3 w lines
     
set title "150001.rec" offset -1,-1

plot '150001_previous.csv' u ($1-1584540000000000):3 w lines,\
     '150001.csv' u ($1-1584540000000000):2 w lines,\
